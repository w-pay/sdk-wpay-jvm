...
@protocol OAIGetCustomerPaymentInstrumentsResultsDataStepUp;
@class OAIGetCustomerPaymentInstrumentsResultsDataStepUp;
...
@interface OAIGetCustomerPaymentInstrumentsResultsDataCreditCards : OAIObject
...
@property(nonatomic) OAIGetCustomerPaymentInstrumentsResultsDataStepUp* stepUp;
