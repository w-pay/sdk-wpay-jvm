...
@class OAIGetCustomerPaymentInstrumentsResultsDataStepUp1;
...
@interface OAIGetCustomerPaymentInstrumentsResultsDataGiftCards : OAIObject
...
@property(nonatomic) OAIGetCustomerPaymentInstrumentsResultsDataStepUp1* stepUp;
