...
import au.com.woolworths.village.sdk.dto.GetCustomerPaymentInstrumentsResultsDataStepUp1;
...
/**
 * GetCustomerPaymentInstrumentsResultsDataGiftCards
 */

public class GetCustomerPaymentInstrumentsResultsDataGiftCards implements Serializable {
  ...
  private GetCustomerPaymentInstrumentsResultsDataStepUp1 stepUp;


  public GetCustomerPaymentInstrumentsResultsDataGiftCards paymentInstrumentId(String paymentInstrumentId) {
  ...
  **/
  ...
  public GetCustomerPaymentInstrumentsResultsDataGiftCards paymentToken(String paymentToken) {
  ...
  **/
  ...
  public GetCustomerPaymentInstrumentsResultsDataGiftCards status(StatusEnum status) {
  ...
  **/
  ...
  public GetCustomerPaymentInstrumentsResultsDataGiftCards lastUpdated(OffsetDateTime lastUpdated) {
  ...
  **/
  ...
  public GetCustomerPaymentInstrumentsResultsDataGiftCards lastUsed(OffsetDateTime lastUsed) {
   ...
   * @return lastUsed
  **/
  @ApiModelProperty(example = "2017-10-12T13:25:49.770+11:00", required = true, value = "The timestamp the payment instrument was last used in the container. The timestamp format is ISO8601. Will be null if never used.")
  ...
  public GetCustomerPaymentInstrumentsResultsDataGiftCards primary(Boolean primary) {
  ...
  **/
  ...
  public GetCustomerPaymentInstrumentsResultsDataGiftCards allowed(Boolean allowed) {
  ...
  **/
  ...
  public GetCustomerPaymentInstrumentsResultsDataGiftCards programName(String programName) {
  ...
  **/
  ...
  public GetCustomerPaymentInstrumentsResultsDataGiftCards cardSuffix(String cardSuffix) {
  ...
  **/
  ...
  public GetCustomerPaymentInstrumentsResultsDataGiftCards stepUp(GetCustomerPaymentInstrumentsResultsDataStepUp1 stepUp) {
  ...
  **/
  ...
  public GetCustomerPaymentInstrumentsResultsDataStepUp1 getStepUp() {
    return stepUp;
  }


  public void setStepUp(GetCustomerPaymentInstrumentsResultsDataStepUp1 stepUp) {
    this.stepUp = stepUp;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetCustomerPaymentInstrumentsResultsDataGiftCards getCustomerPaymentInstrumentsResultsDataGiftCards = (GetCustomerPaymentInstrumentsResultsDataGiftCards) o;
    return Objects.equals(this.paymentInstrumentId, getCustomerPaymentInstrumentsResultsDataGiftCards.paymentInstrumentId) &&
        Objects.equals(this.paymentToken, getCustomerPaymentInstrumentsResultsDataGiftCards.paymentToken) &&
        Objects.equals(this.status, getCustomerPaymentInstrumentsResultsDataGiftCards.status) &&
        Objects.equals(this.lastUpdated, getCustomerPaymentInstrumentsResultsDataGiftCards.lastUpdated) &&
        Objects.equals(this.lastUsed, getCustomerPaymentInstrumentsResultsDataGiftCards.lastUsed) &&
        Objects.equals(this.primary, getCustomerPaymentInstrumentsResultsDataGiftCards.primary) &&
        Objects.equals(this.allowed, getCustomerPaymentInstrumentsResultsDataGiftCards.allowed) &&
        Objects.equals(this.programName, getCustomerPaymentInstrumentsResultsDataGiftCards.programName) &&
        Objects.equals(this.cardSuffix, getCustomerPaymentInstrumentsResultsDataGiftCards.cardSuffix) &&
        Objects.equals(this.stepUp, getCustomerPaymentInstrumentsResultsDataGiftCards.stepUp);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetCustomerPaymentInstrumentsResultsDataGiftCards {\n");
