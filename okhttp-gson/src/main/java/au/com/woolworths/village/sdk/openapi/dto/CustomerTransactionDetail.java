...
public class CustomerTransactionDetail implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionId, type, executionTime, status, refundReason, paymentRequestId, merchantReferenceId, grossAmount, merchantId, instruments, basket);
  }
